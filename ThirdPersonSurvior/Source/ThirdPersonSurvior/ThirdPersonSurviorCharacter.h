...
#include "ThirdPersonSurviorCharacter.generated.h"
...
UCLASS(config = Game)
class AThirdPersonSurviorCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	int GetCurrentGemsAmount() const;
